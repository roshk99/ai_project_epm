...
if __name__ == "__main__":
    ...
    setup = {
        ...
        'train_portion': 0.6,   # the fraction of dataset from the beginning that will be used for training
        'test_portion': 0.4     # the fraction of dataset from the end that will be used for testing
    }
